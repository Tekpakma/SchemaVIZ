...
export type BuilderDocumentActions = {
  ...
  setLayerTextContent: (id: string, textContent: unknown) => void
  ...
  return useMemo(() => {
    ...
    return {
      ...
      actions: {
        ...
        setLayerTextContent: (id: string, textContent: unknown) => {
          builderActions.setLayerTextContent(tabId, id, textContent)
          markDirty()
        },
