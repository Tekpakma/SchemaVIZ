  ...
  de: {
    translation: {
      ...
      assistant: {
        ...
        hint: 'Enter sendet, Shift+Enter für eine neue Zeile.',
        inputLabel: 'Nachricht an den Assistenten',
        intro:
          'Beschreiben Sie, was das Diagramm zeigen soll. Der Assistent liest das Schema, baut die Schritte und zeichnet direkt auf diese Fläche.',
        placeholder:
          'Zeichne die komplette Landschaft der Business Group Retail…',
        rootPlaceholder: 'einem Startmodell',
        send: 'Senden',
        stop: 'Stopp',
        suggestions: {
          landscape:
            'Zeichne die komplette Landschaft ausgehend von {{model}}, zwei Ebenen tief.',
          record: 'Zeige den Datensatz „Retail“ live auf der Fläche.',
          trim: 'Entferne alle Personen- und Log-Modelle aus dem Diagramm.',
        },
        title: 'Diagramm-Assistent',
        toggle: 'Diagramm-Assistent',
        tools: {
          applyDiagramSpec: 'Diagramm auf die Fläche gebracht',
          findRecords: 'Datensätze gesucht',
          getModelDetails: 'Modell gelesen',
          getRecord: 'Datensatz gelesen',
          getSchemaDigest: 'Schema gelesen',
          listModels: 'Modelle gelistet',
          removeModels: 'Modelle entfernt',
          setLayoutDirection: 'Layout-Richtung gesetzt',
          setRootRecord: 'Live-Datensatz gesetzt',
          suggestDiagram: 'Landschaft vorgeschlagen',
          validateDiagram: 'Diagramm geprüft',
        },
      },
      commandCenter: {
      ...
      builder: {
        ...
        grouping: {
          ...
          hint: 'Gruppe: Kinder werden im Eltern-Knoten gezeichnet. Breakout: Knoten bricht aus der Eltern-Gruppe aus. Referenz: nur eine Linie zum bereits gezeichneten Datensatz.',
          mode_breakout: 'Breakout',
          mode_group: 'Gruppe',
          mode_none: 'Baum',
          mode_reference: 'Referenz',
  ...
  en: {
    translation: {
      ...
      assistant: {
        ...
        error: 'The assistant could not answer.',
        hint: 'Enter sends, Shift+Enter adds a line.',
        inputLabel: 'Message to the assistant',
        intro:
          'Describe what the diagram should show. The assistant reads the schema, builds the steps and draws straight onto this canvas.',
        placeholder: 'Draw the whole landscape of the Retail business group…',
        rootPlaceholder: 'a root model',
        send: 'Send',
        stop: 'Stop',
        suggestions: {
          landscape:
            'Draw the complete landscape starting from {{model}}, two levels deep.',
          record: 'Show the record "Retail" live on the canvas.',
          trim: 'Remove every person and log model from the diagram.',
        },
        title: 'Diagram assistant',
        toggle: 'Diagram assistant',
        tools: {
          applyDiagramSpec: 'Diagram placed on the canvas',
          findRecords: 'Searched records',
          getModelDetails: 'Read model',
          getRecord: 'Read record',
          getSchemaDigest: 'Read schema',
          listModels: 'Listed models',
          removeModels: 'Removed models',
          setLayoutDirection: 'Set layout direction',
          setRootRecord: 'Set live record',
          suggestDiagram: 'Suggested landscape',
          validateDiagram: 'Validated diagram',
        },
      },
      commandCenter: {
      ...
      builder: {
        ...
        grouping: {
          ...
          hint: 'Group: children render inside the parent node. Breakout: node escapes its parent group. Reference: only a line to the record where it is already drawn.',
          mode_breakout: 'Breakout',
          mode_group: 'Group',
          mode_none: 'Tree',
